      ...
      >
        ...
        <div class="flex items-center space-x-4">
          <div class="flex space-x-6">
            <a
              href="https://adlist.moexin.cn/list/adlist.txt"
    ...
    <main class="container mx-auto px-8 py-8">
      <div class="bg-white rounded-xl shadow-md p-6 mb-8">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <div class="flex items-center bg-blue-50 px-3 py-1 rounded-full">
            <span class="rule-type-badge bg-pattern text-white">正则规则</span>
        ...
        <section class="lg:col-span-1">
          ...
          <div class="space-y-2">
            ...
            <button
              ...
              class="mt-2 px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 text-sm"
              @click="showAllDomain = !showAllDomain"
            >
              {{ showAllDomain ? "收起" : "显示更多" }}
            </button>
          </div>
        </section>
...
const RULES_URL = "https://adlist.moexin.cn/list/adlist.txt";
...
const getRules = async () => {
  try {
    ...
    showNotificationMessage("获取规则失败，请检查网络连接", "error");
  }
};
